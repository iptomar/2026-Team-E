...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('form_submissions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('form_template_id')->constrained('form_templates')->cascadeOnDelete(); // qual o formulário usado
            $table->foreignId('user_id')->constrained('users')->cascadeOnDelete(); // quem preencheu
